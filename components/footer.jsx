        ...
        <div className="rounded-2xl bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl p-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-col items-center md:items-start gap-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-2xl font-bold text-white">AML Airways</span>
              </div>
              <p className="text-sm text-white/70 text-center md:text-left">
                Your premium airline booking experience
              </p>
            </div>

            {/* Links */}
            <nav className="flex flex-wrap items-center justify-center gap-6">
              <a className="text-sm text-white/80 hover:text-white transition-colors" href="#">
                Terms of Service
              </a>
              <a className="text-sm text-white/80 hover:text-white transition-colors" href="#">
                Privacy Policy
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-white/60">
              © {new Date().getFullYear()} AML Airways. All rights reserved.
            </p>
